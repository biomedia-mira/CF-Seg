...
from train_setup import setup_dataloaders, setup_directories, setup_logging, setup_optimizer, setup_tensorboard
...
def main(args: Hparams):
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=lambda x: x * 0 + 1)
